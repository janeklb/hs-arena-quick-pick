...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tierlist = __webpack_require__(207);
	
	var _HSArenaQuickPick = __webpack_require__(208);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppContainer = __webpack_require__(171);
...
/***/ function(module, exports) {
	...
	exports.resetTierList = resetTierList;
	exports.requestTierList = requestTierList;
	var tierlistUrlBase = 'http://thelightforge.com/api/TierList/Latest';
	...
	function requestTierList() {
	  ...
	  return function (dispatch, getState) {
	    ...
	    if (state.tierlist && state.tierlist.ready) {
	      ...
	      fetch(createTierListUrl(state.locale)).then(function (resp) {
	        return resp.json();
	      }).then(function (json) {
	        return dispatch(updateTierList(json));
	      }).then(function () {
	        return dispatch(notifyTierListReady());
	      });
	    }
	  };
	}
	...
	(function () {
	  ...
	  __REACT_HOT_LOADER__.register(createTierListUrl, 'createTierListUrl', '/home/janek/git/hs-arena-quick-pick/src/actions/tierlist.js');
	
	  __REACT_HOT_LOADER__.register(notifyTierListReady, 'notifyTierListReady', '/home/janek/git/hs-arena-quick-pick/src/actions/tierlist.js');
	
	  __REACT_HOT_LOADER__.register(updateTierList, 'updateTierList', '/home/janek/git/hs-arena-quick-pick/src/actions/tierlist.js');
	
	  __REACT_HOT_LOADER__.register(resetTierList, 'resetTierList', '/home/janek/git/hs-arena-quick-pick/src/actions/tierlist.js');
	
	  __REACT_HOT_LOADER__.register(requestTierList, 'requestTierList', '/home/janek/git/hs-arena-quick-pick/src/actions/tierlist.js');
	
	  __REACT_HOT_LOADER__.register(tierlistUrlBase, 'tierlistUrlBase', '/home/janek/git/hs-arena-quick-pick/src/actions/tierlist.js');
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Deck = __webpack_require__(209);
	
	var _Deck2 = _interopRequireDefault(_Deck);
	
	var _CardPicker = __webpack_require__(210);
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'form-inline', style: { display: 'inline-block', marginLeft: '14px' } },
	          _react2.default.createElement(_HeroPicker2.default, null)
	        )
	      ),
	      _react2.default.createElement(
	        'p',
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: 'http://thelightforge.com/TierList', target: '_blank' },
	          'The Light Forge Tier List'
	        )
	      )
	    ),
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'col-sm-4' },
	            _react2.default.createElement(_CardPicker2.default, { slot: 'first' })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'col-sm-4' },
	            _react2.default.createElement(_CardPicker2.default, { slot: 'second' })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'col-sm-4' },
	            _react2.default.createElement(_CardPicker2.default, { slot: 'third' })
	          )
	        )
	      ),
	      _react2.default.createElement(
	...
	(function () {
	  ...
	  __REACT_HOT_LOADER__.register(_default, 'default', '/home/janek/git/hs-arena-quick-pick/src/HSArenaQuickPick.js');
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  __REACT_HOT_LOADER__.register(_default, 'default', '/home/janek/git/hs-arena-quick-pick/src/Deck.js');
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeroPicker = function (_Component) {
	  _inherits(HeroPicker, _Component);
	
	  function HeroPicker() {
	    _classCallCheck(this, HeroPicker);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(HeroPicker).apply(this, arguments));
	  }
	
	  _createClass(HeroPicker, [{
	    key: 'render',
	    value: function render() {
	      var _props = this.props;
	      var dispatch = _props.dispatch;
	      var selectedHero = _props.selectedHero;
	
	
	      return _react2.default.createElement(
	        'select',
	        { className: 'form-control input-lg', value: selectedHero,
	          onChange: function onChange(e) {
	            return dispatch((0, _heropicker.selectHero)(e.target.value));
	          } },
	        _react2.default.createElement(
	          'option',
	          { value: '' },
	...
	var _default = (0, _reactRedux.connect)(mapStateToProps)(HeroPicker);
	...
	(function () {
	  ...
	  __REACT_HOT_LOADER__.register(mapStateToProps, 'mapStateToProps', '/home/janek/git/hs-arena-quick-pick/src/HeroPicker.js');
	
	  __REACT_HOT_LOADER__.register(heroes, 'heroes', '/home/janek/git/hs-arena-quick-pick/src/HeroPicker.js');
	
	  __REACT_HOT_LOADER__.register(HeroPicker, 'HeroPicker', '/home/janek/git/hs-arena-quick-pick/src/HeroPicker.js');
	
	  __REACT_HOT_LOADER__.register(_default, 'default', '/home/janek/git/hs-arena-quick-pick/src/HeroPicker.js');
	})();
...
/***/ function(module, exports) {
	...
	(function () {
	  ...
	  __REACT_HOT_LOADER__.register(selectHero, 'selectHero', '/home/janek/git/hs-arena-quick-pick/src/actions/heropicker.js');
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  __REACT_HOT_LOADER__.register(_default, 'default', '/home/janek/git/hs-arena-quick-pick/src/store.js');
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rootReducer = (0, _redux.combineReducers)({
	  deck: _deck2.default,
	  tierlist: _tierlist2.default,
	  locale: _locale2.default,
	  cardpicker: _cardpicker2.default,
	  selectedHero: _heropicker2.default
	});
	...
	(function () {
	  ...
	  __REACT_HOT_LOADER__.register(rootReducer, 'rootReducer', '/home/janek/git/hs-arena-quick-pick/src/reducers/root.js');
	
	  __REACT_HOT_LOADER__.register(_default, 'default', '/home/janek/git/hs-arena-quick-pick/src/reducers/root.js');
	})();
...
/***/ function(module, exports) {
	...
	(function () {
	  ...
	  __REACT_HOT_LOADER__.register(deck, "deck", "/home/janek/git/hs-arena-quick-pick/src/reducers/deck.js");
	
	  __REACT_HOT_LOADER__.register(initialState, "initialState", "/home/janek/git/hs-arena-quick-pick/src/reducers/deck.js");
	})();
...
/***/ function(module, exports) {
	...
	function findHeroScore(card, hero) {
	  ...
	  try {
	    ...
	    for (var _iterator = card.Scores[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	  ...
	  try {
	    for (var _iterator2 = card.Scores[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	...
	function tierlist() {
	  ...
	  switch (action.type) {
	    ...
	    case 'UPDATE_TIER_LIST':
	      var tierlist = action.tierlist;
	
	
	      return _extends({}, tierlist, {
	        ready: false
	      });
	    ...
	    case 'SELECT_HERO':
	      ...
	      var heroCards = state.Cards.filter(function (card) {
	        return card.Hero === null || card.Hero === hero;
	      }).map(function (card) {
	...
	(function () {
	  ...
	  __REACT_HOT_LOADER__.register(findHeroScore, 'findHeroScore', '/home/janek/git/hs-arena-quick-pick/src/reducers/tierlist.js');
	
	  __REACT_HOT_LOADER__.register(tierlist, 'tierlist', '/home/janek/git/hs-arena-quick-pick/src/reducers/tierlist.js');
	})();
...
/***/ function(module, exports) {
	...
	function locale() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? 'enUS' : arguments[0];
	  var action = arguments[1];
	...
	(function () {
	  ...
	  __REACT_HOT_LOADER__.register(locale, 'locale', '/home/janek/git/hs-arena-quick-pick/src/reducers/locale.js');
	})();
...
/***/ function(module, exports) {
	...
	(function () {
	  ...
	  __REACT_HOT_LOADER__.register(selectedHero, 'selectedHero', '/home/janek/git/hs-arena-quick-pick/src/reducers/heropicker.js');
	})();
...
/***/ }
/******/ ]);
//# sourceMappingURL=quickpick-bundle.js.map